...
$existsIosApp = file_exists("app/iosbuyerapp.plist");

if($existsIosApp)
{
    $iosAppUrl = file_get_contents("app/iosbuyerapp.plist");
    
    $existsIosApp = $iosAppUrl != "";
}
$existsAndroidApp = file_exists("app/androidbuyerapp.apk");
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row">
            <div class="panel-body" style="text-align:center">
                ...
                <?php 
                      ...
                      {
                          $downloadUrl = "{$downloadPath}app/androidbuyerapp.apk";
                      }
                ?>
