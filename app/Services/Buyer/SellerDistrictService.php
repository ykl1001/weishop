...
class SellerDistrictService extends \YiZan\Services\SellerDistrictService { 
     ...
     * @return [array]              [数组]
     */
    public static function buyerLists($city, $keywords)
    {
     ...
     * @return [array]              [结果代码]
     */
    public static function districtcreate($sellerId, $provinceId, $cityId, $areaId, $address, $name, $row, $mapPoint, $mapPos) {
        $result = array(
            'code'  => self::SUCCESS,
            'data'  => null,
            'msg'   => Lang::get('api_staffwap.success.add')
