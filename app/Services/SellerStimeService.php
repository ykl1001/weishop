...
use YiZan\Models\SellerServiceTimeNo;
use YiZan\Models\Seller;
use YiZan\Utils\Time;
use DB, Lang, Validator;

class SellerStimeService extends BaseService

{
   ...
   public static function insert($sellerId, $weeks, $hours) {
    ...
    public static function getList($sellerId) {
        $list = SellerServiceTimeSet::with('stime')->where('seller_id', $sellerId)->get()->toArray();
    ...
    public static function detail($sellerId, $id) {
        $data = SellerServiceTimeSet::where('seller_id', $sellerId)->where('id', $id)->first()->toArray();
        return $data;
    }
