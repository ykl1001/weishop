...
class PropertyService extends \YiZan\Services\PropertyService {
    ...
    public static function getpropertysystemList($sellerId, $page, $pageSize){
    ...
    public static function getPropertysystem($id){
        return PropertySystem::find($id);
    }

    public static function propertysystemSave($sellerId,$id,$sort, $name, $type,$status){
        $result =
            [
                'code'	=> 0,
                'data'	=> null,
    ...
    public static function deletePropertysystem($id){
        $result =
            [
                'code'	=> 0,
                'data'	=> null,
        ...
        PropertySystem::where('id', $id)->delete();
        return $result;
    }
