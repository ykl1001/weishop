...
class SellerStaffMoneyLog extends Base {
    ...
    const TYPE_SEND_FEE     = 'send_fee';//配送服务费
    ...
    public function getTypeStrAttribute() {
        ...
        if (in_array($type, ['order_confirm','seller_recharge', 'system_recharge', 'property_fee','send_fee'])){
            $typeStr = '收入';            
