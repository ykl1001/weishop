 ...
 * 员工
 */
class SystemStaffController extends AuthController {
	/**
	 * 员工管理-员工列表
	 */
	...
	public function save(){
		...
		return $this->success(Lang::get('admin.code.98008'), u('SystemStaff/index'), $result['data']);
	}
	...
	public function destroy(){
		...
		return $this->success(Lang::get('admin.code.98005'), u('SystemStaff/index'), $result['data']);
	}
