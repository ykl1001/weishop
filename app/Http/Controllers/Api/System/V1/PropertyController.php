...
use YiZan\Services\System\PropertyService;
use Lang, Validator;
...
class PropertyController extends BaseController 
{
    ...
    public function propertysystemget()
    {
        $result = PropertyService::getPropertysystem(intval($this->request('id')));

        return $this->outputData($result);
    }

    public function propertysystemlists(){
        $result = PropertyService::getpropertysystemList(
            (int)$this->request('sellerId'),
            max((int)$this->request('page'), 1),
    ...
    {
        $result = PropertyService::propertysystemSave(
            (int)$this->request('sellerId'),
    ...
    public function propertysystemdelete()
    {
        $result = PropertyService::deletePropertysystem(intval($this->request('id')));
