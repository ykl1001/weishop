			...
			<div class="p10">
				...
				<div class="m-tab m-smfw-ser">
					@yizan_begin
	                    <yz:list>
							<btns>
								<linkbtn label="添加黄页" url="{{ u('YellowPages/create') }}" css="btn-gray"></linkbtn>
								<linkbtn type="destroy" css="btn-gray"></linkbtn>
							</btns> 
							<table css="goodstable" relmodule="YellowPages" checkbox="1">
								<columns> 
								<column code="id" label="编号" align="center"></column>
                                    <column code="mobile" label="联系方式" align="center"></column>

                                    <column code="name" label="黄页名称" align="center"></column>
