...
@section('right_content')
    ...
    <div id="checkList" class="">
        <div class="u-ssct clearfix">
            <form id="yzForm" class="" name="yzForm" method="post" action="{{ u('Businessstatistics/dayAccount') }}" target="_self"> 
       ...
       <table>
            ...
            <tbody>  
                ...
                <tr>
                  ...
                  <td>{{ number_format($list_item['activityNewMoney']+$list_item['systemFullSubsidy']+$list_item['totalDiscountFee']+$list_item['totalIntegralFee'], 2) }}</td>
