...
@section('content')
    @if(!empty($data))
        <div class="content infinite-scroll infinite-scroll-bottom pull-to-refresh-content" data-ptr-distance="55" data-distance="50" id=''>
            ...
            <div id="list">
                    @include('wap.community.usercenter.wealth_item')
            </div>
    ...
    @else
        <div class="x-null pa w100 tc">
            ...
            <p class="f12 c-gray mt10">赶紧推荐你的小伙伴，获取佣金吧！</p>
        </div>
    @endif
    ...
    <script>
        $(function() {
            ...
            $(document).on('infinite', '.infinite-scroll-bottom', function() {
                ...
                $.post("{{ u('UserCenter/wealthList') }}", data, function(result){
                    groupLoading = false;
