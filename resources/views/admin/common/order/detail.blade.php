...
@section('return_link')
    ...
    @endif
    @if($data['isCanEnd'])
        <a href="javascript:;" class="fr btn mb10 hsbtn-78 ml20" onclick="$.orderEnd(1)">订单完结</a>
    @endif
@stop
					...
					<table>
						<tr>
						    <td style="padding-left:10px">
                                ...
                                <p class=" f14">取货地址：{{$data['seller']['address']}}</p>
...
<script type="text/tpl" id="serviceContent">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $.orderEnd = function(){
                var msg = "确定手动完结订单吗？";
                $.ShowConfirm(msg, $.orderEndOk);
            }

            $.orderEndOk = function() {
                $.refundRemark({{ORDER_STATUS_FINISH_USER}}, 1);
            }
