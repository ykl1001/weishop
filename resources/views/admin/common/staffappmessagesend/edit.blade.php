...
@yizan_begin
	<yz:form id="yz_form" action="send">   
		...
		<yz:fitem name="userType" label="推送员工类型">
			<yz:Radio name="userType"  css="userType" options="0,1" texts="所有人,指定员工" checked="0"></yz:Radio>
		</yz:fitem>
	                 ...
	                 <tbody>
	                 	<tr>
		                    ...
		                    <td width="230" style="padding:0; height:35px;">
		                        <input type="text" class="form-control" placeholder="搜索手机号" id="fansName" style="width:120px;">
		...
		<script type="text/javascript">
			jQuery(function($){
	            ...
	            $('#fansNameBtn').click(function(){
	                $.post("{{ u('staff/search') }}",{"name":$("#fansName").val()},function(result){  
