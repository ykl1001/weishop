...
@section('right_content')
	...
	<div id="checkList" class="">
        <div class="u-ssct clearfix">
            <form id="yzForm" class="" name="yzForm" method="GET" action="{{ u('BusinessStatistics/index') }}" target="_self">
                    ...
                    <div class="tp fr tr" style="right: 10px;"><img src="{{asset('images/wenhao.jpg')}}">
                        <div class="tanchuang tl">
                            <div class="tccon">
                                ...
                                <p>有效订单的总金额。公式：营业额 = 商品销售额 + 配送收入 = 在线支付（含补贴）+ 现金支付</p>
                                ...
                                <p class="title">商家补贴</p>
                                <p>指商家通过促销活动为用户补贴，公式：满减金额+特价商品折扣金额</p>
                                <p class="title">平台补贴</p>
                                <p>指由平台针对指定商家为用户补贴，公式：首单减免金额+满减金额+优惠券+积分抵扣</p>
                                <p class="title">客单价</p>
	...
	<yz:list>
        <btns>
            <linkbtn label="导出到EXCEL" type="export">
                <attrs>
                    <url>{{ u('BusinessStatistics/export', Input::all() ) }}</url>
                </attrs>
            </linkbtn>
        </btns>
       <table>
