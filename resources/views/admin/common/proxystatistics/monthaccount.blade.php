...
@section('right_content')
	...
	<div id="checkList" class="">
        <div class="u-ssct clearfix">
            <form id="yzForm" class="" name="yzForm" method="get" action="{{ u('ProxyStatistics/monthAccount') }}" target="_self">
                <div class="search-row clearfix"> 
                    ...
                    <div class="u-fitem clearfix" id="select_year">
                        ...
                        <input type="hidden" value="{{$seller['id']}}" name="sellerId" />
                    </div> 
	...
	<yz:list>
        <btns>
            <linkbtn label="导出到EXCEL" type="export">
                <attrs>
                    <url>{{ u('ProxyStatistics/monthaccountexport', Input::all() ) }}</url>
                </attrs>
            </linkbtn>
        </btns>
       ...
       <table pager="no">
    		...
    		<tbody> 
        		<tr>
        		  ...
        		  <td style="cursor: pointer;"><a href="{{ u('ProxyStatistics/dayAccount', ['sellerId'=>$args['sellerId'], 'day'=>$l['daytime']]) }}" class=" blu agree" >明细</a></td>
    		 	</tr>
    		  	@endforeach
    		</tbody>
    	</table>
