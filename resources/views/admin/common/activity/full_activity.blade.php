	...
	@yizan_begin
        @if($edit)
            <yz:form id="yz_form" nobtn="1">
                ...
                <yz:fitem label="活动内容">
                    <p>&nbsp;满&nbsp;&nbsp;<input type="text" name="fullMoney" class="u-ipttext w195" placeholder="请输入金额" value="{{$data['fullMoney']}}" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';if(this.value<0)this.value='';else this.value2=this.value;">&nbsp;元</p>
                    <p class="gray ml25">此金额为商品总价，不包含其它费用</p>
                    <p class="mt10">&nbsp;减&nbsp;&nbsp;<input type="text" name="cutMoney" class="u-ipttext w195" placeholder="请输入金额" value="{{$data['cutMoney']}}" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';if(this.value<0)this.value='';else this.value2=this.value;">&nbsp;元</p>
                </yz:fitem>
        ...
        @else
    		<yz:form id="yz_form" action="save_full_activity">
                <yz:fitem name="startTime" label="开始时间" type="date"></yz:fitem>
                <yz:fitem name="endTime" label="结束时间" type="date"></yz:fitem>
                <yz:fitem label="活动内容">
                    <p>&nbsp;满&nbsp;&nbsp;<input type="text" name="fullMoney" class="u-ipttext w195" placeholder="请输入金额" value="{{$data['fullMoney']}}" onkeyup="if(this.value==this.value2)return;if(this.value.search(/^\d*(?:\.\d{0,2})?$/)==-1)this.value=(this.value2)?this.value2:'';if(this.value<0)this.value='';else this.value2=this.value;">&nbsp;元</p>
    ...
    $(function(){
        ...
        $("input.p-addbtn").click(function(){
            ...
            $.post("{{ u('Activity/save_full_data') }}", saveData, function(res){
                window.location.href = "{{ u('Activity/addSeller', ['type' => 5]) }}";
            });
        });
