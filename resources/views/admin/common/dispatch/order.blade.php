        ...
        <yz:list>
            <tabs>
                <navs>
                    <nav label="配送中订单">
                        <attrs>
                            <url>{{ u('Dispatch/index',['status'=>'10','nav'=>'nav2']) }}</url>
                            <css>{{$nav2}}</css>
                        </attrs>
                    </nav>
                    <nav label="配送完成订单">
                        <attrs>
                            <url>{{ u('Dispatch/index',['status'=>'11','nav'=>'nav3']) }}</url>
                            <css>{{$nav3}}</css>
                        </attrs>
                    </nav>
                    <nav label="异常订单">
                        <attrs>
                            <url>{{ u('Dispatch/index',['status'=>'12','nav'=>'nav4']) }}</url>
                            <css>{{$nav4}}</css>
                        </attrs>
                    </nav>
                </navs>
            ...
            @yizan_stop
                <row>
                    ...
                    <div id="city-form-item" class="u-fitem clearfix ">
                        <span class="f-tt">
                             所在城市:
                        </span>
                        <div class="f-boxr">
