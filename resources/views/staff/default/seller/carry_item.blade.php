    ...
    <ul>
        <li class="item-content">
            <div class="item-inner">
                ...
                <div class="item-after"><span class="f_red mr5" id="is_carry_money" data="{{$bank['moneyCycle'] or 0}}">¥{{$bank['moneyCycle'] or 0}}</span></div>
            </div>
        </li>
        <li class="item-content">
            <div class="item-inner">
...
<div class="account_hd_bottom content-padded">
    @if(!$bank['lockCycl'])
        ...
        <p class="button button-fill button-success bg_a5a5a5">申请提现</p>
    @else
        <p class="button button-fill button-success ajax-success-bnt">申请提现</p>
    @endif
</div>
<div class="list-block">
    <ul>
        <li class="item-content">
            <div class="item-inner">
                @if($bank['bank']['bank'])
                    ...
                    <div class="item-after"><a href="#" onclick="JumpURL('{{u('Seller/bank',['id'=>$bank['bank']['id']])}}','#seller_bank_view',2)"  class="f_red">详情></a></div>
                @else
                    <div class="item-title">暂无银行卡</div>
                    <div class="item-after"><a href="#" onclick="JumpURL('{{u('Seller/bank')}}','#seller_bank_view',2)"  class="f_red">去绑定></a></div>
                @endif
            </div>
        </li>
    </ul>
